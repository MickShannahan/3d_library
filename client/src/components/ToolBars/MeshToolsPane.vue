...
<template>
  <section class="tools glass-pane border rounded rounded-3 p-2" >
    <div data-bs-toggle="collapse" data-bs-target="#tools-collapse" class="selectable-primary rounded-2"><i class="mdi mdi-tools mb-3"></i> TOOLS</div>
    ...
    <div class="d-flex flex-column gap-2 " >
      ...
      <!-- Transform -->
      <section>
        <div class="small-input-group rounded-3 d-flex flex-column gap-1">
          <label>Transform</label>
          <div class="d-flex gap-1 flex-wrap">

            <!-- Center model at world origin -->
            <button
              class="tool-btn flex-grow-1"
              :disabled="!selectedMeshes.length"
              v-tooltip="'Move selection center to world origin (0,0,0)'"
              @click="centerModel"
            >
...
.text-axis-x { color: #ff4444; }
.text-axis-y { color: #44cc44; }
.text-axis-z { color: #4488ff; }
